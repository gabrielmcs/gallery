...
//SELECT TO THE SUPERIOR PART - DOCS FILE
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<link rel="icon" type="image/png" href="../imagens/favicon-16x16.png" sizes="16x16" />
        ...
        <title>Sanovo Technology South America - Dashboard</title>
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item active">
					<a class="nav-link" href="index.php">
						<i class="fas fa-fw fa-2x text-dark fa-tachometer-alt"></i> <a class="nav-link" href="index.php"> <i class="fas fa-fw fa-2x text-dark fa-tachometer-alt"></i> <span>Painel de controle</span></a></a>				</li>
	...
	<!--			<li class="nav-item">
			...
			-->	
				<!-- BOTAO ITEM -->
				<li class="nav-item"> <a class="nav-link" href="item.php"> <i class="fas fa-fw fa-cogs fa-2x text-dark"></i> <span class="text-dark">Item</span> </a> </li>
				<!-- Tela de Docs -->
                <!--
					<li class="nav-item">
					<a class="nav-link collapsed" href="../docs.php" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
						<i class="fas fa-fw fa-book fa-2x text-dark"></i>
						<span class="text-dark">Manuais</span>
					</a>
					-->
                <!--	<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"> -->
                <!--	<div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">Controle de Manuais:</h6>
					<!--	<a id="btnNuevo2" data-toggle="modal" class="collapse-item" href="#">Adicionar Manuais</a> -->
                <!--		<a id="btnNuevo3" data-toggle="modal" class="collapse-item" href="#">Adicionar Manuais</a>
							<!-- <a class="collapse-item" href="cards.php">Cards</a> -->
                <!--			</div>
					</div>
				</li>
			-->
                <!-- BOTAO DOCS (MANUAIS, DESENHOS E PROCEDIMENTOS) -->
                <li class="nav-item"> <a class="nav-link" href="docs.php"> <i class="fas fa-fw fa-book fa-2x text-dark"></i> <span class="text-dark">Docs</span> </a> </li>
                <!-- Tela de Usuarios -->
                <!--		<li class="nav-item">
			...
			-->
				...
				-->
                <!-- BOTAO USUARIOS -->
                <li class="nav-item"> <a class="nav-link" href="user.php"> <i class="fas fa-fw fa-user fa-2x text-dark"></i> <span class="text-dark">User</span> </a> </li>
                <!-- BOTAO GALLERY -->
                <li class="nav-item"> <a class="nav-link" href="gallery.php"> <i class="fas fa-camera-retro text-dark fa-2x"></i> <span class="text-dark">Gallery</span> </a> </li>
                <!-- BOTAO AGENDA DE SERVICOS -->
                <li class="nav-item"> <a class="nav-link" href="https://agenda.eggmac.net" target="_blank"> <i class="fas fa-calendar text-dark fa-2x"></i> <span class="text-dark">Agenda</span> </a> </li>
                <!-- BOTAO MAPA DE INSTALACOES -->
                <li class="nav-item"> <a class="nav-link" href="maps.php"> <i class="fas fa-globe text-dark fa-2x"></i> <span class="text-dark">Map</span> </a></li>
                <!-- BOTAO SAIR -->
				<li class="nav-item">
