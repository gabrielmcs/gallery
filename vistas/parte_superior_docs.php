...
<link rel="icon" type="image/png" href="../imagens/favicon-16x16.png" sizes="16x16" />
        ...
        <title>Sanovo LATAM - Controller - Cadastro de Documentos</title>
		...
		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<!-- 	<div class="sidebar-brand-icon rotate-n-15">
					...
					<i><img class="center-block img-fluid d-block" width="50" height="50" src="../imagens/icone.png" ></i>
					</div>
	...
	<!--			<li class="nav-item">
		...
		<!--		<li class="nav-item">
			...
			<!--			<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionSidebar">
				...
				<li class="nav-item">
					<a class="nav-link" href="https://agenda.eggmac.net" target="_blank">
						<i class="fas fa-calendar text-dark fa-2x"></i>
						<span class="text-dark">Agenda</span>
					</a>
				</li>	
				...
				<li class="nav-item">
					<a class="nav-link" href="maps.php">
						<i class="fas fa-globe text-dark fa-2x"></i>
						<span class="text-dark">Map</span>
					</a>
				</li>
