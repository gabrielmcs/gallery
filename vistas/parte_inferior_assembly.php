...
<footer class="sticky-footer bg-white">
	<div class="container my-auto">
		<div class="copyright text-center my-auto">
            <span><h6>Sanovo Controller LATAM - <span class="badge badge-pill badge-danger" ><?PHP echo date("Y"); ?></h6></span>
		</div>
	</div>
</footer>
<!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="../bd/logout.php">Close</a>
...
<script type="text/javascript" src="main_gallery.js"></script>  
</body>
</html>