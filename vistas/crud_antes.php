...
/////////////////////////////////////////////////////////////////////////////////		
	...
	switch($action){
		case "create": //alta
        $consulta = $conexion->prepare("INSERT INTO item (codigo, datahora, descricao_EN, orcamento, cliente, custo, moeda, desconto, sistema, imagen, imagen2, origem) VALUES(:codigo, :datahora, :descricao_EN, :orcamento, :cliente, :custo, :moeda, :desconto, :sistema, :imagen, :imagen2, :origem) ");		
		$consulta->execute(
		array(
		':codigo'	=>	$codigo,
		':datahora'	=>	$datahora,
        ...
        $consulta = $conexion->prepare("UPDATE item SET codigo=:codigo, datahora=:datahora, descricao_EN=:descricao_EN, orcamento=:orcamento, cliente=:cliente, custo=:custo, moeda=:moeda, desconto=:desconto, sistema=:sistema, imagen=:imagen, imagen2=:imagen2, origem=:origem WHERE id=:id");	
