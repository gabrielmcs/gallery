...
//SELECT TO THE SUPERIOR PART - ITEM FILE
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<link rel="icon" type="image/png" href="../imagens/favicon-16x16.png" sizes="16x16" />
        ...
        <title>Sanovo Technology South America - Gallery Controller</title>
...
/*  ESTE ESTILO DEFINIQ UE AS COLUNAS DO DATATABLE NAO PASSEM DE UM NUMERO ESPECIFICO DE PX PARA NAO ESTOURAR AS LINHAS   */		
	...
	<!--			<li class="nav-item">
			...
			-->
              ...
              <!--			<a id="btnNuevo4" data-toggle="modal" class="collapse-item" href="#">Adicionar Usuários</a>
				...
				-->
              <!-- BOTAO USUARIOS -->
                <li class="nav-item"> <a class="nav-link" href="user.php"> <i class="fas fa-fw fa-user fa-2x text-dark"></i> <span class="text-dark">Usuário</span> </a> </li>
                <!-- BOTAO GALLERY -->
                  <li class="nav-item"> <a class="nav-link" href="gallery.php"> <i class="fas fa-camera-retro text-dark fa-2x"></i> <span class="text-dark">Galeria</span> </a> </li>
